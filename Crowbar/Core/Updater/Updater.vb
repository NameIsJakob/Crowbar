...
#Region "CheckForUpdate"
    ...
    Private Sub CheckForUpdate_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs)
        ...
        client.DefaultRequestHeaders.UserAgent.Add(New ProductInfoHeaderValue("ZeqMacaw_Crowbar", My.Application.Info.Version.ToString(2)))
        ...
        Try
            Dim response = client.GetAsync("https://api.github.com/repos/ZeqMacaw/Crowbar/releases/latest").GetAwaiter().GetResult()
            response.EnsureSuccessStatusCode()
            Dim root = response.Content.ReadFromJsonAsync(Of Dictionary(Of String, JsonElement)).GetAwaiter().GetResult()
        ...
        If Me.theAppVersion Is Nothing OrElse Me.theRemoteFileLink = "" Then
...
#Region "Download"
    ...
    Public Sub Download(ByVal checkForUpdate_ProgressChanged As ProgressChangedEventHandler, ByVal checkForUpdate_RunWorkerCompleted As RunWorkerCompletedEventHandler, ByVal download_DownloadProgressChanged As DownloadProgressEventHandler, ByVal download_DownloadFileCompleted As AsyncCompletedEventHandler, ByVal localPath As String)
    ...
    Private Async Function DownloadAfterCheckForUpdateAsync() As Task
        ...
        If FileManager.PathExistsAfterTryToCreate(Me.theLocalPath) Then
            ...
            Dim client As New HttpClient()
            Try
                Dim response = Await client.GetAsync(remoteFileUri, Me.theCancellation.Token)
                response.EnsureSuccessStatusCode()
                Dim responseStream = Await response.Content.ReadAsStreamAsync(Me.theCancellation.Token)
                Dim byteReadCount = 0
                Using outputFile = File.OpenWrite(Me.theLocalPathFileName)
                    ...
                    Do
                        ...
                        Me.theDownloadProgressChangedHandler.Invoke(client, New DownloadProgressEventArgs(byteReadCount, response.Content.Headers.ContentLength.Value))
                ...
                End If
                Me.theDownloadFileCompletedHandler(client, New AsyncCompletedEventArgs(Nothing, False, Me.theLocalPathFileName))
            Catch e As Exception
                Me.theDownloadFileCompletedHandler(client, New AsyncCompletedEventArgs(e, True, Me.theLocalPathFileName))
            End Try
        End If
    End Function
...
#Region "Update"
    ...
    Public Sub Update(ByVal checkForUpdate_ProgressChanged As ProgressChangedEventHandler, ByVal checkForUpdate_RunWorkerCompleted As RunWorkerCompletedEventHandler, ByVal download_DownloadProgressChanged As DownloadProgressEventHandler, ByVal download_DownloadFileCompleted As AsyncCompletedEventHandler, ByVal localPath As String, ByVal update_ProgressChanged As ProgressChangedEventHandler, ByVal update_RunWorkerCompleted As RunWorkerCompletedEventHandler)
        Me.theDownloadProgressChangedHandler = download_DownloadProgressChanged
        Me.theDownloadFileCompletedHandler = download_DownloadFileCompleted
    ...
    Private Sub CheckForUpdate_RunWorkerCompleted(ByVal sender As System.Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs)
        ...
        Else
            If Me.theDownloadTaskIsEnabled Then
                ...
                Dim unused = Me.DownloadAfterCheckForUpdateAsync()
            End If
        End If
    End Sub
...
#Region "Data"
    ...
    Private theDownloadProgressChangedHandler As DownloadProgressEventHandler
